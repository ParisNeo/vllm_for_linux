...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Hugging Face repo id passed directly (default: QuantTrio/GLM-5.2-Int4-Int8Mix)",
    )
    parser.add_argument(
        "--model",
        type=str,
...
def main():
    ...
    if model_id == "QuantTrio/GLM-5.2-Int4-Int8Mix":
        ASCIIColors.cyan("No model specified. Defaulting to QuantTrio/GLM-5.2-Int4-Int8Mix.")
