...
TP_SIZE="${TP_SIZE:-8}"
GPU_MEM_UTIL="${GPU_MEM_UTIL:-0.8723}"
MAX_MODEL_LEN="${MAX_MODEL_LEN:-255360}"
...
Tested Architecture: 8x H100 - Full Tensor Parallel for GLM-5.3 (Native FP8)
...
echo " Optimized for 8x H100 (W4A8 configuration)"
