...
def main():
    ...
    # Résolution du dossier cible relativement à l'emplacement du script
    ...
    if not args.allow_pattern:
        # Exclut les formats obsolètes non natifs pour vLLM afin de gagner de la place disque
    ...
    try:
        ...
        snapshot_path = snapshot_download(
            ...
            max_workers=8, # Accélère le téléchargement sur votre serveur
        )
