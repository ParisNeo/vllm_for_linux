...
This directory contains optimized scripts to deploy **Qwen 3.6 (Text + Vision)**, **Qwen Image Edit**, and **Wan 2.2 Video Generation** simultaneously on a single machine using vLLM. 

The architecture is specifically tuned for a **4x A100 (40GB)** setup, utilizing Tensor Parallelism for the LLM and isolating the diffusion pipelines on dedicated GPUs.
