...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Hugging Face repo id passed directly (default: Qwen/Qwen-Image-2.1)",
    )
    parser.add_argument(
        "--model",
        type=str,
...
def main():
    ...
    if model_id == "Qwen/Qwen-Image-2.1":
        ASCIIColors.cyan("No model specified. Defaulting to Qwen/Qwen-Image-2.1.")
