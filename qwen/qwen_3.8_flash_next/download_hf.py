...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="Qwen/Qwen3.8-Flash-Next-FP8",
        help="Hugging Face repo id passed directly (default: Qwen/Qwen3.8-Flash-Next-FP8)",
    )
    parser.add_argument(
        "--model",
        type=str,
...
def main():
    ...
    if model_id == "Qwen/Qwen3.8-Flash-Next-FP8":
        ASCIIColors.cyan("No model specified. Defaulting to Qwen/Qwen3.8-Flash-Next-FP8.")
